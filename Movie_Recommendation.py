...
#loading data
movies = pd.read_csv(r'D:\ml-latest-small\movies.csv',encoding="Latin1")
Ratings = pd.read_csv(r'D:\ml-latest-small\ratings.csv',encoding="Latin1")
Tags = pd.read_csv(r'D:\ml-latest-small\tags.csv',encoding="Latin1")
...
# user similarity on replacing NAN by user avg (CENTERED COSINE)
...
print(np.fill_diagonal(cosine, 0 ))
...
#     movies_rating = movies_rating.pivot_table(columns=['movieId'], index='userId', values='rating')
